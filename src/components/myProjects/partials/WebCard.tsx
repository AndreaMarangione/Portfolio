...
const WebCard = ({p}: { p: WebProject }) => (
    <div
        ...
        <button
            type="button"
            className="mt-4 flex w-full items-center justify-center gap-2.5 rounded-lg border border-primary/50 bg-primary/[0.08] p-2.5 text-[13.5px] font-medium text-[#f0b49c] transition-colors hover:border-primary/70 hover:bg-primary/15 hover:text-white"
        >
            <GithubIcon/>
            View on GitHub
        </button>
